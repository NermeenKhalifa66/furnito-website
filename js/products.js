...
function addToCart(productId) {
    ...
    // جلب سلة التسوق الحالية من LocalStorage أو إنشاء جديدة
    ...
    if (existingProductIndex !== -1) {
        ...
        // إذا لم يكن موجودًا، إضافته مع كمية 1
        cart.push({
            id: product.id,
            title: product.title,
            price: product.price,
    ...
    // تحديث عداد سلة التسوق في الواجهة
    updateCartCounter();
}
